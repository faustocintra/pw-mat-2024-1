...
class HttpError extends Error {
  ...
  const myfetch1 = {}  // Objeto vazio
  
  // Lê o endereço do back-end a partir do arquivo .env.local
  const baseUrl = import.meta.env.VITE_API_BASE1
  ...
  myfetch1.post = async function(path, body) {
